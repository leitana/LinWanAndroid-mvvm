...
public class TRTCAudioCallActivity extends AppCompatActivity {
    ...
    public void showWaitingResponseView() {
        ...
        ImageLoader.INSTANCE.load(this, mSponsorUserInfo.userAvatar, layout.getImageView());
        //2. 展示电话对应界面
    ...
    private void showOtherInvitingUserView() {
        ...
        for (int index = 0; index < mOtherInvitingUserInfoList.size() && index < MAX_SHOW_INVITING_USER; index++) {
            ...
            ImageLoader.INSTANCE.load(this, userInfo.userAvatar, imageView);
    ...
    private TRTCAudioLayout addUserToManager(UserInfo userInfo) {
        ...
        ImageLoader.INSTANCE.load(this, userInfo.userAvatar, layout.getImageView());
        return layout;
    }
