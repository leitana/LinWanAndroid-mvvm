...
import com.tencent.liteav.trtccalling.utils.ImageLoader;
...
public class TRTCVideoCallActivity extends AppCompatActivity {
    ...
    public void showWaitingResponseView() {
        ...
        ImageLoader.INSTANCE.load(this,mSponsorUserInfo.userAvatar,mSponsorAvatarImg);
    ...
    private void showOtherInvitingUserView() {
        ...
        for (int index = 0; index < mOtherInvitingUserInfoList.size() && index < MAX_SHOW_INVITING_USER; index++) {
            ...
            ImageLoader.INSTANCE.load(this, mSponsorUserInfo.userAvatar, imageView);
    ...
    private TRTCVideoLayout addUserToManager(UserInfo userInfo) {
        ...
        if (!TextUtils.isEmpty(userInfo.userAvatar)) {
            ImageLoader.INSTANCE.load(this,mSponsorUserInfo.userAvatar,layout.getHeadImg());
        }
        return layout;
    }
